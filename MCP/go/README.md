# Spotify Web Api Node API MCP Server

This MCP (Model Content Protocol) server provides access to Spotify Web Api Node API API functionality through HTTP, HTTPS, and STDIO transport modes.
